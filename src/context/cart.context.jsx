...
export const CartProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        setCartItemAmount(newCartAmount);
    }, [cartItems])
    ...
    const value = {isCartOpen, setIsCartOpen, addItemToCart, removeItemFromCart, clearItemFromCart, cartItems, cartItemAmount, cartTotal};
